...
<?php
  ...
  {
     $menu = $_POST['menu']; 
     $submenu=$_POST['tbxsubmenu'];
   
     $query = mysql_query( "INSERT INTO submenu (menu-id)
                       VALUES ('$menu')");
     echo $menu;
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="box box-success">
                ...
                <div class="box-body">
                  <form method="post" action="submenu.php" role="form">
                    <!-- text input -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="tbxsubmenu" class="form-control" placeholder="Enter ...">
                    </div>
